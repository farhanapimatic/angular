...
angular.module('APIMATICCalculatorLib')
    .factory('OraclePaaSCalculatorController', ['$q',
        'Configuration',
        'HttpClient',
        'APIHelper',
        'BaseController',
        OraclePaaSCalculatorController
    ]);

    function OraclePaaSCalculatorController($q, Configuration, HttpClient, APIHelper, BaseController) {
        return {
            /**
